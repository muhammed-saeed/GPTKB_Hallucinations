...
def _openai_batch_loop(args, paths, qdb, fdb, el_cfg, ner_cfg, ner_llm):
    """
    Queue manager inspired by your reference:
...
def main():
    ...
    ap.add_argument("--openai-batch-size", type=int, default=128,
    ...
    if args.openai_batch and _is_openai(el_cfg):
        ...
        # ---- threaded mode (non-OpenAI models OR OpenAI without --openai-batch) ----
        write_lock = Lock()
